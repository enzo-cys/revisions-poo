...
class Electronic extends AbstractProduct implements SockableInterface {
    ...
    // Implémentation de SockableInterface -------------------------------

    // Ajoute des unités au stock (ne fait rien pour des valeurs <= 0)
    ...
    // Retire des unités au stock (la quantité ne devient pas négative)
    ...
    // Méthodes spécifiques pour persister / lire les Electronic -------------
