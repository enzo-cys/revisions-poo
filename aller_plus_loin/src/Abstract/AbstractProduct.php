...
/**
 * Classe de base abstraite contenant propriétés et utilitaires partagés.
 * Implémente EntityInterface pour garantir la présence de getId/setId.
 */
abstract class AbstractProduct implements EntityInterface
{
    ...
    // Getters / setters (EntityInterface)
    ...
    /**
     * JOB 01 : Méthode save()
     * Crée ou met à jour le produit selon que l'ID existe ou non
     * @return self|false
     */
    public function save()
    {
        if ($this->id === null) {
            ...
            // ID existe -> mise à jour
            return $this->update();
        }
    }

    // Récupère la Category liée si présente
    ...
    // Helpers de connexion / manipulation de product -----------------------
    ...
    // Insert générique dans product ; retourne id inséré ou false
    ...
    // Update générique de product ; retourne true/false
    ...
    // Hydrate l'instance depuis une ligne product
    public function hydrateFromProductRow(array $row): void
    {
    ...
    // Méthodes abstraites que les classes concrètes doivent implémenter
