...
class Product {
    ...
    // Job 10 : met à jour la ligne correspondant à l'instance courante et retourne $this si succès, sinon false
    public function update() {
        // besoin d'un id pour mettre à jour
        if ($this->id === null) {
            return false;
        }
        ...
        try {
            ...
            // Vérifier qu'une ligne a bien été affectée (facultatif)
            $rowCount = $stmt->rowCount();
            if ($rowCount === 0) {
                // aucune ligne modifiée : peut signifier que les données sont identiques
                // on considère cela comme succès (retourner $this)
                return $this;
            }
